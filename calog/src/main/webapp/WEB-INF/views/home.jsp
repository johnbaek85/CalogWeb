...
<body>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-6">
							<div class="about-text">
								<p>You just need to select what you have during the meals
									and the exercises you have done in a day. It automatically
									calculate and show you the calories you have taken and consumed
									during a day, a wekk, a month and a year with graph chart to
									see it and compare it easily.</p>
							</div>
						</div>
						<!-- About Text -->
						<div class="col-12 col-lg-6">
							<div class="about-text">
								<p>Furthermore, you can check your alcohol saturation
									percentage and check the total amount of the alcohol you have
									had during specific period as well through the detector(sold
									separately). You just put it everything you put in your body,
									we will calculate them and show you.</p>
							</div>
						</div>
						<!-- About Button Group -->
						<div class="col-12">
	...
	<div
		class="fitness-pricing-table-area section-padding-100-0 bg-img bg-overlay bg-fixed"
		style="background-image: url(./resources/img/bg-img/bg-7.jpg);">
		<div class="container">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-price-table mb-100">
						...
						<div class="price-table-content">
							...
							<!-- Price Data -->
							<ul class="price-data">
								<li><i class="fa fa-circle" aria-hidden="true"></i> Donec
									molestie tincidunt tellus</li>
								<li><i class="fa fa-circle" aria-hidden="true"></i> Sit
									amet aliquet auctor nisi</li>
								<li><i class="fa fa-circle" aria-hidden="true"></i> Dut
									purus eleifentincid</li>
							</ul>
							<!-- btn -->
